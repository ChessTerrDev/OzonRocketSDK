...
- [X] [Получить место передачи отправлений DropOff на склад](#ролучить-место-передачи-отправлений-DropOff-н-склад)
...
#### Заказы (в разработке)
#### Отгрузка (в разработке)
#### Трекинг (в разработке)
#### Накладные (в разработке)
#### Отчёты (в разработке)
#### Акты расхождения (в разработке)
#### Тарифы (в разработке)
#### Этикетки (в разработке)
